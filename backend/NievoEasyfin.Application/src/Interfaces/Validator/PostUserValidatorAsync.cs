    ...
    public class PostUserValidator : AbstractValidator<PostUserRequest>
    {
        public PostUserValidator()
        {
            RuleFor(x => x.Name)
                ...
                .WithErrorCode(EnumErrosApi.INVALID_NAME_INPUT.ToString());
            ...
            RuleFor(x => x.Password)
                ...
                .WithErrorCode(EnumErrosApi.INVALID_PASSWORD_INPUT.ToString());
            ...
            RuleFor(x => x.Email)
                ...
                .WithErrorCode(EnumErrosApi.INVALID_EMAIL_INPUT.ToString());
        }
    }
}