...
public class AuthReplica : EasyFinDbContext
{
    protected override string PGSQL_DATABASE_CONNECTION_STRING => DotNetEnv.Env.GetString("PGSQL_DATABASE_AUTH_CONNECTION_READ_REPLICA_STRING");
