            ...
            <div className="w-full max-w-[440px] flex flex-col">
                ...
                <Card className="w-full">
                    ...
                    <div className="flex flex-col items-center justify-center mb-8">
                        ...
                        <h1 className="text-slate-900 dark:text-white text-2xl font-bold tracking-tight">{t('login.title')}</h1>
                    ...
                    <form action="#" className="flex flex-col gap-5">
                        ...
                        <Input
                            ...
                            icon="lock"
                            rightElement={
                                <button className="text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 flex items-center justify-center p-1 rounded-md transition-colors" type="button">
                        ...
                        <div className="flex justify-end">
                            <Link to="/forgot-password" className="text-primary text-sm font-medium hover:underline decoration-primary/50 underline-offset-4">{t('login.forgot_password')}</Link>
                        </div>
                        ...
                        <div className="relative flex py-2 items-center">
                            ...
                            <span className="flex-shrink mx-4 text-slate-400 dark:text-slate-500 text-xs font-medium uppercase tracking-wider">{t('login.or_divider')}</span>
                            <div className="flex-grow border-t border-slate-300 dark:border-slate-700"></div>
                        </div>
                        {/* SSO Button */}
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-slate-500 dark:text-slate-400 text-sm">
                            {t('login.no_account')}
                            <a className="text-primary font-bold hover:text-primary/80 transition-colors ml-1" href="#">{t('login.create_account')}</a>
                        </p>
                    </div>
                </Card>
            </div>
